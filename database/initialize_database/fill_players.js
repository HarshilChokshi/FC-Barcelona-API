...
//   });
    ...
    var umtiti = new Player({
      ...
      position: 'Center Back',
      rating: 84,
      description: `Samuel Umtiti is a French professional footballer who plays as a centre-back for Spanish club FC Barcelona and the France national team.
He began his professional career with Lyon in 2012, winning the Coupe de France and Trophée des Champions that year. He totalled 170 games and three goals before a €25 million transfer to Barcelona in 2016.
After winning 47 caps and scoring three goals at youth level, including winning the 2013 FIFA U-20 World Cup, Umtiti represented France at UEFA Euro 2016, where his nation reached the final.`,
      imageURL: 'http://s.weltsport.net/bilder/spieler/gross/170711.jpg'
     });

     var turan = new Player({
       fullName: 'Arda Turan',
       popularName: 'turan',
       nationality: 'Turkey',
       age: 30,
       ...
       rating: 83,
       description: `Arda Turan is a Turkish professional footballer who plays as an attacking midfielder for Spanish club FC Barcelona and captains the Turkey national team.[3][4]
...
Turan was ranked 38th in "The 100 Best Footballers in the World" by The Guardian in 2014, the only player on the list to be born in Turkey.[5] Down by 40 steps compared to previous year, Turan was ranked 78th in Guardian's list of 2015.[6] On 25 November 2014, Turan was nominated for the UEFA Team of the Year for 2014, among 40 other players.[7][8]
As of March 2016, he has 89 senior national caps and 17 goals for Turkey and following a successful UEFA Euro 2008 campaign, he was ranked eighth in a selection of the 100 Best Young Football Players in the World piece published by Spanish magazine Don Balón in July 2008.`,
       imageURL: 'http://s.weltsport.net/bilder/spieler/gross/30203.jpg'
      });

     var roberto = new Player({
       ...
       imageURL: 'http://s.weltsport.net/bilder/spieler/gross/171905.jpg'
      });

      var rafinha = new Player({
        fullName: 'Rafael Alcántara do Nascimento',
        popularName: 'rafinha',
        nationality: 'Brazil',
        age: 24,
        ...
        rating: 82,
        description: `Rafael Alcántara do Nascimento commonly known as Rafinha, is a Brazilian professional footballer who plays as an attacking midfielder for Spanish club FC Barcelona and the Brazil national team.
...
Rafinha represented both Spain and Brazil at youth level, before debuting with the latter at senior level in 2015.`,
        imageURL: 'http://s.weltsport.net/bilder/spieler/gross/179256.jpg'
       });

       var denis = new Player({
         fullName: 'Denis Suarez',
         popularName: 'denis',
         nationality: 'Spain',
         age: 23,
         ...
         rating: 82,
         description: `Denis Suárez Fernández is a Spanish professional footballer who plays as an attacking midfielder for FC Barcelona`,
         imageURL: 'http://s.weltsport.net/bilder/spieler/gross/200516.jpg'
        });

        var gomes = new Player({
          ...
          position: 'Left Center Midfield',
          rating: 82,
          description: `André Filipe Tavares Gomes is a Portuguese professional footballer who plays as a central midfielder for Spanish club FC Barcelona and the Portugal national team.
...
Gomes gained 37 caps for Portugal all youth levels accounted for, including six for the under-21s. He represented the nation at Euro 2016, winning the tournament.`,
          imageURL: 'http://s.weltsport.net/bilder/spieler/gross/211898.jpg'
         });

         var mathieu = new Player({
           fullName: 'Jeremy Mathieu',
           popularName: 'mathieu',
           nationality: 'France',
           age: 33,
           ...
           position: 'Center back',
           rating: 81,
           description: `Jérémy Mathieu is a French professional footballer who plays as a centre-back or a left-back for Spanish club FC Barcelona and the France national team.
...
A full international for France since 2011, he was selected in the squad to represent France at UEFA Euro 2016 but dropped out with injury on 28 May, to be replaced by Samuel Umtiti.`,
           imageURL: 'http://s.weltsport.net/bilder/spieler/gross/11706.jpg'
         });

         var cillessen =  new Player({
           fullName: 'Jasper Cillessen',
           popularName: 'cillessen',
           ...
           position: 'Goalkeeper',
           rating: 80,
           description: `Jasper Cillessen is a Dutch professional footballer who plays as a goalkeeper for Spanish club FC Barcelona.
...
In May 2011, he received his first call-up for the Netherlands national team. He made his international debut in 2013 and was the country's first-choice goalkeeper as they finished third at the 2014 FIFA World Cup.`,
           imageURL: 'http://s.weltsport.net/bilder/spieler/gross/123282.jpg'
         });

         var vidal =  new Player({
           ...
           position: 'Right Back',
           rating: 79,
           description: `Aleix Vidal Parreu is a Spanish professional footballer who plays for FC Barcelona. Mainly a right-back and a player of great speed, he can also operate as a right winger.[1][2]
Having spent his early career at a string of lower-league and reserve teams, he became a regular at Almería, helping them to promotion to La Liga, and also won the Europa League with Sevilla before signing for Barcelona in 2015 for €17 million.`,
           imageURL: 'http://s.weltsport.net/bilder/spieler/gross/166570.jpg'
         });

         var alcacer = new Player({
           fullName: 'Francisco Paco Alcácer García',
           popularName: 'alcacer',
           nationality: 'Spain',
           age: 23,
           ...
           position: 'Striker',
           rating: 77,
           description: `Francisco "Paco" Alcácer García is a Spanish professional footballer who plays as a striker for FC Barcelona and the Spain national team.
...
Alcácer won the European Championship twice with Spain's under-19 side, and made his senior international debut in 2014.`,
           imageURL: 'http://s.weltsport.net/bilder/spieler/gross/177606.jpg'
         });

         var digne = new Player({
           ...
           imageURL: 'http://s.weltsport.net/bilder/spieler/gross/192458.jpg'
         });

         var masip = new Player({
           ...
           position: 'Goalkeeper',
           rating: 75,
           description: `Jordi Masip López is a Spanish professional footballer who plays as a goalkeeper for FC Barcelona.`,
           imageURL: 'http://s.weltsport.net/bilder/spieler/gross/171903.jpg'
         });
...
//           });
  ...
  mathieu.save().then((doc) => {
    console.log(JSON.stringify(doc, undefined, 2));
  }, (err) => {
    console.log(err);
  });

  cillessen.save().then((doc) => {
    console.log(JSON.stringify(doc, undefined, 2));
  }, (err) => {
    console.log(err);
  });
